		...
		<?php if (!$error_warning) { ?>
			<center>
				<table style="width: 100%;">
					<tr>
						<td width="150px"><?php echo $text_settled; ?></td>
						<td><?php echo $settled; ?></td>
					</tr>
					<tr>
						<td width="150px"><?php echo $text_orderId; ?></td>
						<td><?php echo $orderId; ?></td>
					</tr>
					<tr>
						<td width="150px"><?php echo $text_saleOrderId; ?></td>
						<td><?php echo $saleOrderId; ?></td>
					</tr>
					<tr>
						<td width="150px"><?php echo $text_saleReferenceId; ?></td>
